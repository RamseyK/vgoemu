...
void ServerSocket::HandlePacket(char *pData, unsigned short nLength)
{
    ...
    switch(*opcode)
    {
        ...
        case 0x68360801: //01 08 36 68 CMSG_CHARWINDOWTEXT1_REQ
        printf("Handler: 01 08 36 68 CMSG_CHARWINDOWTEXT1_REQ\n");
        send_CHARWINDOWTEXT1_RESP(this);
        oclient.client_sequence = *(char*)pData;
        ack_seq(this, oclient.client_sequence);
        break;

        case 0x9C302002: //02 20 30 9C CMSG_SVR_ENTERREQ:
        printf("Handler: 02 20 30 9C CMSG_SVR_ENTERREQ\n");
        send_SERVERTRANSFER(this);
        oclient.client_sequence = *(char*)pData;
        ack_seq(this, oclient.client_sequence);
        break;
        
        case 0x9C382002: //02 20 30 9C CMSG_SVR_ENTERREQ:
        printf("Handler: 02 20 38 9C CMSG_SVR_ENTERREQ\n");
        send_SERVERTRANSFER(this);
        oclient.client_sequence = *(char*)pData;
        ack_seq(this, oclient.client_sequence);
        break;

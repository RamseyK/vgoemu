...
{
     send_hardcode_pkt(Server, SMSG_CHARWINDOWTEXT1_RESP, sizeof(SMSG_CHARWINDOWTEXT1_RESP));
}

void send_SERVERTRANSFER(ServerSocket *Server)
{
     send_hardcode_pkt(Server, SMSG_SERVERTRANSFER, sizeof(SMSG_SERVERTRANSFER));
}
